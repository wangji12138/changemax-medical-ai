...
public class TextReviewUtil {
     ...
     *
     * */
    public String post(String requestUrl, String accessToken, String params)
            throws Exception {
        //设置contentType
    ...
    public String post(String requestUrl, String accessToken, String contentType, String params)
            throws Exception {
        //设置编码格式为UTF-8
     ...
     *
     * */
    public String post(String requestUrl, String accessToken, String contentType, String params, String encoding)
            throws Exception {
        //构造请求url，将请求信息写入url中
